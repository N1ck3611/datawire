              ...
              <div className="mt-4">
                <div className="flex items-center gap-3 p-3 bg-[#5865F2]/10 border border-[#5865F2]/30 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-white font-medium text-sm truncate">{user.global_name || user.username}</p>
                ...
                {user.discordGuilds && user.discordGuilds.length > 0 && (
                  <div className="flex gap-1.5 mt-2 flex-wrap">
                    {user.discordGuilds.slice(0, 5).map(guild => (
                      <div 
                        key={guild.id}
                        className="flex items-center gap-1.5 px-2 py-0.5 bg-white/5 rounded"
                        title={guild.name}
                      >
                        {guild.icon ? (
                          <img 
                        ...
                        <span className="text-white/70 text-[10px] truncate max-w-[80px]">{guild.name}</span>
                      </div>
                    ))}
                  </div>
                )}
