      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <GlassCard className="p-8">
            ...
            {user?.discordId && (
              <div className="flex items-center gap-3 mt-4 p-3 bg-[#5865F2]/10 border border-[#5865F2]/30 rounded-lg">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-[#5865F2]/20 flex items-center justify-center overflow-hidden">
                    {user.avatar ? (
                ...
                <div className="flex-1">
                  <p className="text-white font-medium text-sm">{user.global_name || user.username}</p>
