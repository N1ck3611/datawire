    ...
    try {
      ...
      if (data.success) {
        ...
        if (result.binary || result.file || result.data) {
          ...
          // Format the data with proper line breaks - handle multiple formats
          let formattedData = binaryData
          if (typeof binaryData === 'string') {
            // Handle escaped newlines (\r\n, \n, /r, /n)
            formattedData = binaryData
              .replace(/\\r\\n/g, '\n')
              .replace(/\\r/g, '\n')
              .replace(/\\n/g, '\n')
              .replace(/\/r\/n/g, '\n')
            ...
            formattedData = JSON.stringify(binaryData, null, 2)
          }
...
${separator}
Generated by Datawire.cc IntelX Integration
